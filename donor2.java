...
import java.sql.*;
class donor2 extends JFrame implements ActionListener 
{
  ...
  try
  {
	...
	*/
	//insert into test0 values(1,'aaa','bbb','ccc',1212131415,'abcd234@gmail.com','baramti','pune');
	sql = "insert into test0 values("+t1.getText()+",'"+t2.getText()+"','"+t3.getText()+"','"+t4.getText()+
	"','"+calb.getText()+"',"+t5.getText()+",'"+cb1.getSelectedIndex()+"','"+t6.getText()+"','"+cb2.getSelectedIndex()+"','"+t7.getText()+"','"+t8.getText()+"')";
