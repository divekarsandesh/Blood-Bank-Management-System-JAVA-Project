...
class pass_recov extends JFrame implements ActionListener
{
 JLabel l1,l2,l3,l4;
   ...
   try
  {
	  if(e.getSource() ==b1)
	  {
	   if(t1.getText().length()==0)
       {
		 ...
		 {
		  JOptionPane.showMessageDialog(null,"not given Enter Mobile No","warning",JOptionPane.WARNING_MESSAGE);
		 t2.requestFocus();
		 }
	  ...
	  if(Username.equals(rs.getString(1)) && MobileNo.equals(rs.getString(2)) && ReferenceNo.equals(rs.getString(3)) && EnterOTP.equals(rs.getString(4)))
	 {
